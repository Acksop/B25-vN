...
function wcode_afficher_aide(){
        window.open('scriptPHP/w-code/wcode.aide.htm','_blank','toolbar=0, location=0, directories=0, status=0, scrollbars=1, resizable=0, copyhistory=0, menuBar=0, width=730, height=500');
}
