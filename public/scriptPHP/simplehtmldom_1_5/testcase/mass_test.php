...
$files = array(
    ...
    array(
        'name' => 'cyberciti.htm',
        'url' => 'http://www.cyberciti.biz/tips/configure-ubuntu-grub-to-load-freebsd.html'
    ),
    array(
        'name' => 'myspace.htm',
    ...
    array(
        'name' => 'flickr.htm',
        'url' => 'http://www.flickr.com/tour/upload/'
    ),
    array(
        'name' => 'amazon.htm',
