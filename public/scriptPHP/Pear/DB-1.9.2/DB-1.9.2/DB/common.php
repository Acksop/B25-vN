...
;
     ...
     *
     * @param
     *            boolean the boolean value to be quoted.
     * @return string the quoted string.
     ...
     *
     * @param
     *            float the float value to be quoted.
     * @return string the quoted string.
     * @see DB_common::quoteSmart()
     * @since Method available since release 1.7.8.
     */
     ...
     *            the feature you're curious about
     *            
     ...
     *
     * @param string $option
     *            the option name you're curious about
     *            
     ...
     * @param string $where
     *            for update queries: the WHERE clause to
     ...
     *            the associative array where $key is a
     ...
     * @param mixed $data
     *            array, string or numeric data to be used in
     ...
     *
     * @param resource $stmt
     *            a DB statement resource returned from execute()
     * @param mixed $data
     *            array, string or numeric data to be used in
     *            execution of the statement. Quantity of items
     *            passed must match quantity of placeholders in
     ...
     *            the SQL query
     * @param mixed $col
     *            which column to return (integer [column number,
     ...
     *            the query result idenifier produced by PHP
     *            
     ...
     *
     * @param
     *            mixed integer error code, or a PEAR error object (all
     ...
     * @param
     *            mixed native error code, integer or string depending the
     *            backend
     * @param
     *            mixed dummy parameter for E_STRICT compatibility with
     *            PEAR::raiseError
     * @param
     *            mixed dummy parameter for E_STRICT compatibility with
     *            PEAR::raiseError
     ...
     * @see PEAR_Error
     */
    function &raiseError($code = DB_ERROR, $mode = null, $options = null, $userinfo = null, $nativecode = null, $dummy1 = null, $dummy2 = null)
    {
     ...
     *            deprecated.
     * @param int $mode
     *            either unused or one of the tableInfo modes:
     *            <kbd>DB_TABLEINFO_ORDERTABLE</kbd>,
     ...
     *
     * @param
     *            boolean true to set the flag overriding the isManip() behaviour,
    ...
    /**
     * Checks if the given query is a manipulation query.
     ...
     *
     * @param array $array
     *            the array to be trimmed (passed by reference)
     *            
     * @return void
     *
     * @access protected
     ...
     *
     * @param array $array
     *            the array to be de-nullified (passed by reference)
     *            
     * @return void
     *
     * @access protected
