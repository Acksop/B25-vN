...
class DB_sqlite extends DB_common
{
     ...
     *            the valid sqlite result resource
     *            
     ...
     *        
     * @see DB_common::raiseError(), DB_sqlite::errorNative(), DB_sqlite::errorCode()
     */
     ...
     *            the error message returned from the database
     *            
     ...
     * @param array $args
     *            SQLITE DRIVER ONLY: a private array of arguments
