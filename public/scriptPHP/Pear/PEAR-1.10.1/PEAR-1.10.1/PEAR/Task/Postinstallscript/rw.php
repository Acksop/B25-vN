...
class PEAR_Task_Postinstallscript_rw extends PEAR_Task_Postinstallscript
{
     ...
     *
     * @param string $id
     *            <paramgroup> id as seen by the script
     * @param array|false $params
     *            array of getParam() calls, or false for no params
     ...
     *            <paramgroup> id of the section referenced by
     *            <conditiontype>
     * @param string $param
     *            name of the <param> from the older section referenced
     *            by <contitiontype>
     * @param string $value
     *            value to match of the parameter
     ...
     * @param string|false $instructions            
     */
    public function addConditionTypeGroup($id, $oldgroup, $param, $value, $conditiontype = '=', $params = false, $instructions = false)
    {
        if ($params && isset($params[0]) && ! isset($params[1])) {
            $params = $params[0];
        }
     ...
     * @return array
     */
    public static function getParam($name, $prompt, $type = 'string', $default = null)
    {
        if ($default !== null) {
            return array(
