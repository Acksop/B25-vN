...
class PEAR_ChannelFile
{
     ...
     */
    public static function &fromArray($data, $compatibility = false, $stackClass = 'PEAR_ErrorStack')
    {
     ...
     */
    public static function &fromArrayWithErrors($data, $compatibility = false, $stackClass = 'PEAR_ErrorStack')
    {
        $a = new PEAR_ChannelFile($compatibility, $stackClass);
        $a->_fromArray($data);
        return $a;
...
";
     ...
     * @param
     *            string
     * @return string|false @error PEAR_CHANNELFILE_ERROR_NO_NAME
     ...
     * @param
     *            string
     * @return string|false @error PEAR_CHANNELFILE_ERROR_NO_SERVER
