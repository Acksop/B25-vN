...
class PEAR_Frontend_CLI extends PEAR_Frontend
{
 ...
 // line prefix
     ...
     *
     * @param array $xml
     *            contents of postinstallscript tag
     * @param object $script
     ...
     * 
     * @param
     *            array an array of arrays, format array('name' => 'paramname', 'prompt' =>
    ...
    function userConfirm($prompt, $default = 'yes')
    {
        ...
        static $positives = array(
            'y',
            'yes',
            'on',
            '1'
        );
        static $negatives = array(
            'n',
            'no',
            'off',
            '0'
        ...
        switch ($command) {
            ...
            case 'search':
                ...
                if (isset($data['headline']) && is_array($data['headline'])) {
                    $this->_tableRow($data['headline'], array(
                        'bold' => true
                    ), array(
                        1 => array(
                            'wrap' => 55
                ...
                natcasesort($p);
                foreach ($p as $name) {
                    $this->_tableRow($packages[$name], null, array(
                        1 => array(
                            'wrap' => 55
                        )
                    ));
