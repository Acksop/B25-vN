    ...
    function _convertPackage($packagexml)
    {
        ...
        if (isset($deps['required']['package'])) {
            ...
            foreach ($deps['required']['package'] as $dep) {
                ...
                if ($dep['channel'] != 'pear.php.net' && $dep['channel'] != 'pecl.php.net' && $dep['channel'] != 'doc.php.net') {
        ...
        if (isset($deps['required']['extension'])) {
            if (! isset($deps['required']['extension'][0])) {
                $deps['required']['extension'] = array(
                    $deps['required']['extension']
                );
            }
        ...
        if (isset($deps['optional']['extension'])) {
            if (! isset($deps['optional']['extension'][0])) {
                $deps['optional']['extension'] = array(
                    $deps['optional']['extension']
                );
            }
