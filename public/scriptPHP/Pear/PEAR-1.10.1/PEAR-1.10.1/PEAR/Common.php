...
define('PEAR_COMMON_PACKAGE_DOWNLOAD_PREG', '/^' . _PEAR_COMMON_PACKAGE_DOWNLOAD_PREG . '\\z/');
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_maintainer_roles'] = array(
    'lead',
    'developer',
    'contributor',
    'helper'
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_release_states'] = array(
    'alpha',
    'beta',
    'stable',
    'snapshot',
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_dependency_types'] = array(
    'pkg',
    'ext',
    'php',
    'prog',
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_dependency_relations'] = array(
    'has',
    'eq',
    'lt',
    'le',
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_file_roles'] = array(
    'php',
    'ext',
    'test',
    'doc',
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_replacement_types'] = array(
    'php-const',
    'pear-config',
    'package-info'
);
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_provide_types'] = array(
    'ext',
    'prog',
    'class',
    'function',
 ...
 * @var array
 */
$GLOBALS['_PEAR_Common_script_phases'] = array(
    'pre-install',
    'post-install',
    'pre-uninstall',
    'post-uninstall',
...
class PEAR_Common extends PEAR
{
    ...
    /**
     * User Interface object (PEAR_Frontend_* class).
     * If null,
     ...
     *
     * @param string $tmpdir
     *            (optional) Directory to use as tmpdir.
    ...
    function _postProcessValidPackagexml(&$pf)
    {
        ...
        unset($arr['old'], $arr['xsdversion'], $arr['contents'], $arr['compatible'], $arr['channel'], $arr['uri'], $arr['dependencies'], $arr['phprelease'], $arr['extsrcrelease'], $arr['zendextsrcrelease'], $arr['extbinrelease'], $arr['zendextbinrelease'], $arr['bundle'], $arr['lead'], $arr['developer'], $arr['helper'], $arr['contributor']);
     ...
     *            (optional) directory where source files
    ...
    function buildProvidesArray($srcinfo)
    {
        ...
        foreach ($srcinfo['declared_classes'] as $class) {
            ...
            $this->pkginfo['provides'][$key] = array(
                'file' => $file,
                'type' => 'class',
                'name' => $class
            );
     ...
     * Considers suggested file name in
     ...
     *            (optional) directory to save file in
     * @param mixed $callback
     *            (optional) function/method to call for status
     *            updates
     * @param false|string|array $lastmodified
     *            header values to check against
     *            for caching
     *            use false to return the header
     *            values from this download
     * @param false|array $accept
     *            Accept headers to send
     * @param false|string $channel
     *            Channel to use for retrieving
     *            authentication
     *            
