...
$wcode_smileys = Array(
    Array(
        ":-D",
        "scriptPHP/w-code/wcode_images/01.gif"
    ),
    Array(
        ";-)",
        "scriptPHP/w-code/wcode_images/02.gif"
    ),
    Array(
        "?-)",
        "scriptPHP/w-code/wcode_images/03.gif"
    ),
    Array(
        ":-\$",
        "scriptPHP/w-code/wcode_images/04.gif"
    ),
    Array(
        "B-)",
        "scriptPHP/w-code/wcode_images/05.gif"
    ),
    Array(
        ":'(",
        "scriptPHP/w-code/wcode_images/06.gif"
    ),
    Array(
        "X-(",
        "scriptPHP/w-code/wcode_images/07.gif"
    ),
    Array(
        ":-*",
        "scriptPHP/w-code/wcode_images/08.gif"
    ),
    Array(
        "^^",
        "scriptPHP/w-code/wcode_images/09.gif"
    ),
    Array(
        ":-|",
        "scriptPHP/w-code/wcode_images/10.gif"
    ),
    Array(
        ":-)",
        "scriptPHP/w-code/wcode_images/11.gif"
    ),
    Array(
        "Z-)",
        "scriptPHP/w-code/wcode_images/12.gif"
    ),
    Array(
        ":-(",
        "scriptPHP/w-code/wcode_images/13.gif"
    )
);
...
$var_temp ++; // Balise pour une video
$wcode_balises[$var_temp][0] = 'avi';
$wcode_balises[$var_temp][1] = '(.*[^\\\\])';
$wcode_balises[$var_temp][2] = '<div><a href="%VALEUR%">%VALEUR%</div>';
$wcode_balises[$var_temp][3] = false;
$wcode_balises[$var_temp][4] = true;
...
function wcode_liste($v, $c)
{
    ...
    $c = $temp;
    if ($v == 'a')
        return '<ul class="lettres">' . $c . '</ul>';
    elseif ($v == '1')
        return '<ul class="numeros">' . $c . '</ul>';
    else
        return '<ul class="normal">' . $c . '</ul>';
}
