...
// ---- repertoire a ouvrir ---------------------------------
$NomRep = RADIEURAE_REP_PATH . "upload_utilisateurs/" . $_SESSION['repertoire'] . "/videos";
$NomSVN = RADIEURAE_SVN_PATH . "upload_utilisateurs/" . $_SESSION['repertoire'] . "/videos";
...
echo "<script language='javascript'>" . "
		...
		function LancerProgressionUpload(){
			timerUpload=setInterval('EnvoyerUpload()', 5);
		}
...
function AfficherLesVideosDisponibles($NomRep, $RepSVN)
{
    ...
    foreach ($TabTousFichier as $Fichier) {
        ...
        if (! is_dir($NomRep . '/' . $Fichier)) {
            ...
            if ($Fexp[1] == "mp4" || $Fexp[1] == "webm" || $Fexp[1] == "ogv") {
