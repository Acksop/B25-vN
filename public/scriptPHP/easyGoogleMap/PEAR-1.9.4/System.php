...
class System
{
     ...
     *            the allowed option short-tags
     * @param string $long_options
     *            the allowed option long-tags
     ...
     * @param integer $maxinst
     *            max. deep of the lookup
     * @param integer $aktinst
     *            starting deep of the lookup
     * @param bool $silent
     *            if true, do not emit errors.
     ...
     * 
     * @param string $args
     *            the name of the director(y|ies) to create
     ...
     *            Value to return if $program is not found
     *            
