...
class PEAR_Frontend extends PEAR
{
     ...
     * 
     * @param mixed $data
     *            data structure containing the information to display
     * @param string $command
     *            command from which this method was called
     * @abstract
     *
     */
     ...
     *            command from which this method was called
     * @param array $prompts
     *            associative array. keys are the input field names
     *            and values are the description
     * @param array $types
     *            array of input field types (text, password,
     *            etc.) keys have to be the same like in $prompts
     * @param array $defaults
     *            array of default values. again keys have
