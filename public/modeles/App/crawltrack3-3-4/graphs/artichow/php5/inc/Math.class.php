...
class awPoint extends awShape
{
     ...
     *
     * @param
     *            Point A Point with the new awlocation
     */
...
class awLine extends awShape
{
     ...
     *            Second point
     * @param int $type
     *            Style of line (default to solid)
     * @param int $thickness
...
class awPolygon extends awShape
{
     ...
     * i.e.
     * the minimum and maximum y value of any point in the polygon
     *
     * @return array
     */
     ...
     * i.e.
     * the minimum and maximum x value of any point in the polygon
     *
     * @return array
     */
