...
abstract class awDriver
{
     ...
     *
     * @param awFileImage $fileImage
     *            The FileImage object to work on
     * @param string $file
     *            Image filename
     */
     ...
     *
     * @param float $x
     *            Position on X axis of the center of the component
     * @param float $y
     *            Position on Y axis of the center of the component
     */
     ...
     *
     * @param int $x
     *            Add this value to X axis
     * @param int $y
     *            Add this value to Y axis
     */
     ...
     *            Image
     * @param int $d1
     *            Destination top-left position
     * @param int $d2
     *            Destination bottom-right position
     * @param int $s1
     *            Source top-left position
     * @param int $s2
     *            Source bottom-right position
     * @param bool $resample
     *            Resample image ? (default to TRUE)
     */
...
abstract class awFontDriver
{
     ...
     *            The Driver object to draw upon
     * @param awText $text
     *            The Text object
     * @param awPoint $point
     *            Where to draw the text
     * @param float $width
     *            The width of the area containing the text
     */
     ...
     *            The Text object
     * @param awDriver $driver
     *            The awDriver object used to draw the graph
     */
...
class awPHPFontDriver extends awFontDriver
{
     ...
     *
     * @param awGDDriver $driver
     *            The GDDriver to draw the text upon
     * @param awText $text
     *            The awText object containing the string to draw
     * @param awPoint $point
     *            Where to draw the text
     * @param float $width
...
class awFileFontDriver extends awFontDriver
{
     ...
     *
     * @param awGDDriver $driver
     *            The awGDDriver object containing the ressource to draw upon
     * @param awText $text
     *            The awText object containing the string to draw
     * @param awPoint $point
     *            Where to draw the string from
     * @param float $width
     *            The width of the area containing the text
     */
    private function gdString(awGDDriver $driver, awText $text, awPoint $point, $width = NULL)
