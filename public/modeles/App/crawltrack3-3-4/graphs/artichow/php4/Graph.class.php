...
class awGraph extends awImage
{
     ...
     *            Graph height
     * @param string $name
     *            Graph name for the cache (must be unique). Let it null to not use the cache.
     * @param int $timeout
     *            Cache timeout (unix timestamp)
     */
     ...
     *            &$label
     * @param int $x
     *            Position on X axis of the center of the text
     * @param int $y
     *            Position on Y axis of the center of the text
     */
     ...
     *
     * @param string $mode
     *            Display mode (can be a file name)
     */
