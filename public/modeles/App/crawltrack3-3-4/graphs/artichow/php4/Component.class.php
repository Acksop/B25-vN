...
class awComponent
{
     ...
     *
     * @param int $width
     *            Component width (from 0 to 1)
     * @param int $height
     *            Component height (from 0 to 1)
     */
     ...
     *
     * @param int $left
     *            Padding in pixels (NULL to keep old value)
     * @param int $right
     *            Padding in pixels (NULL to keep old value)
     * @param int $top
     *            Padding in pixels (NULL to keep old value)
     ...
     *
     * @param float $left
     *            Space in % (NULL to keep old value)
     * @param float $right
     *            Space in % (NULL to keep old value)
     * @param float $bottom
     *            Space in % (NULL to keep old value)
     ...
     *
     * @param int $x
     *            Position X of the center of the component
     * @param int $y
     *            Position Y of the center of the component
     */
     ...
     * @param int $y2            
     * @param bool $aliasing
     *            Use anti-aliasing to draw the component ?
     */
