...
class awAxis
{
     ...
     *
     * @param float $min
     *            Begin of the range of the axis
     * @param float $max
     *            End of the range of the axis
     */
     ...
     *
     * @param
     *            &$to Change number of theses ticks
     * @param
     *            &$from Ticks reference
     * @param float $number
     *            Number of ticks by the reference
     */
    ...
    function reverseTickStyle()
    {
        foreach ($this->ticks as $key => $tick) {
            if ($this->ticks[$key]->getStyle() === TICK_IN) {
                ...
                if ($this->ticks[$key]->getStyle() === TICK_OUT) {
     ...
     *
     * @param int $number
     *            Number of labels to display (can be NULL)
     */
     ...
     *            A new awposition between 0 and 1
     */
     ...
     *            Transform a position between 0 and 1 to a value
     * @param string $toPosition
     *            Transform a value to a position between 0 and 1 on the axis
     */
     ...
     *            &$axis An axis
     * @param float $value
     *            The reference value on the axis
     */
