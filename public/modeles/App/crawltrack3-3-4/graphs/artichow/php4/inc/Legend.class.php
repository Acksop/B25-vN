...
class awLegend
{
     ...
     *
     * @param bool $hide
     *            TRUE to hide legend, FALSE otherwise
     */
     ...
     *            Legend title
     * @param int $type
     *            Legend type (default to LEGEND_LINE)
     */
    ...
    function draw($driver)
    {
        ...
        // Draw legend shadow
        $this->shadow->draw($driver, $p, $p->move($width, $height), SHADOW_OUT);
                ...
                case LEGEND_MARKONLY:
                    ...
                    if ($component->getLegendLineColor() !== NULL) {
                        ...
                        if (is_a($color, 'awColor') and $type !== LEGEND_MARKONLY) {
                            ...
                            $driver->line($color, new awLine($p->move($x, // YaPB ??
$y + $component->getLegendLineThickness() / 2), $p->move($x + 10, $y + $component->getLegendLineThickness() / 2), $component->getLegendLineStyle(), $component->getLegendLineThickness()));
