...
class awLabel
{
     ...
     *
     * @param string $format
     *            New format (printf style: %.2f for example)
     */
     ...
     *
     * @param int $x
     *            Add this interval to X coord
     * @param int $y
     *            Add this interval to Y coord
     */
    function move($x, $y)
    {
    ...
    function getText($key)
    {
        if (is_array($this->texts) and array_key_exists($key, $this->texts)) {
            ...
            if (is_a($this->background, 'awColor')) {
                ...
                if (is_a($this->background, 'awGradient')) {
     ...
     *            center
     * @param int $key
     *            Text position in the array of texts (default to zero)
     */
