...
class awImage
{
     ...
     *
     * @param int $w
     *            Driver width (from 0 to 1) (default to 1)
     * @param int $h
     *            Driver height (from 0 to 1) (default to 1)
     * @param float $x
     *            Position on X axis of the center of the driver (default to 0.5)
     * @param float $y
     *            Position on Y axis of the center of the driver (default to 0.5)
     * @return Driver
     */
    ...
    function drawShadow()
    {
        ...
        $this->shadow->draw($driver, new awPoint(0, 0), new awPoint($this->width, $this->height), SHADOW_IN);
    }
