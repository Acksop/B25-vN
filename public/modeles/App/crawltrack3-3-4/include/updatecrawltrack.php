...
$requetecache = faireUneRequeteOnLine_Crawltrack($sqlcache, $connexion) or exit("MySQL query error");
...
if (empty($tables_actions_error_messages) && empty($fields_actions_error_messages) && $process_ok) {
    ...
    $requeteupdateversion = faireUneRequeteOnLine_Crawltrack($sqlupdateversion, $connexion);
...
if (! $existing_crawlt_site_url_field) : // we need to add the site url in the table
        ?> 
        <form action="index.php" method="POST">
		<input type="hidden" name='navig' value='10'>
		<table width="100%" align="center">
			<tr>
				<td width="100%" align="center"><input name='ok' type='submit'
					value=' <?php echo $language['url_update'] ?> ' size='20'></td>
			</tr>
		</table>
	</form>
	<br>
    ...
    <?phpendif;    <table width="100%" align="center">
				<tr>
					<td width="100%" align="center"><input name="ok" type="submit"
						value=" OK " size="20"></td>
				</tr>
