...
if ($period == 3) // case one year
{
    ...
    $requeteseograph = faireUneRequeteOnLine_Crawltrack($sqlseograph, $connexion);
    while ($ligne = exploiterLigneResultatBDD_Crawltrack_row($requeteseograph)) {
