...
<meta name="author" content="Jean-Denis Brun">
	<meta name="description"
		content="CrawlTrack spiders and crawlers tracker, web analytics and SEO script">
		<meta name="keywords"
			content="crawler,tracker,webmaster,statistics,robots,site,webmestre,statistiques,searchengines,moteur de recherche">
	<?php
   ...
   <?php }else{ ?>
    ...
    <link rel="stylesheet" type="text/css" href="./styles/style.css"
			...
			<link rel="stylesheet" type="text/css"
				href="./styles/alternate_style.css" media="screen" />
			<link rel="stylesheet" type="text/css" href="./styles/imprim.css"
				media="print" />
			<!--[if IE]>
