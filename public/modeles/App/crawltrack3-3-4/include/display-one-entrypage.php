...
$requetepageid = faireUneRequeteOnLine_Crawltrack($sqlpageid, $connexion);
$nbrresultpageid = exploiterNombreLigneResultatBDD_Crawltrack($requetepageid);
if ($nbrresultpageid >= 1) {
	while ($ligne = exploiterLigneResultatBDD_Crawltrack_row($requetepageid)) {
		$pageidlist[] = $ligne[0];		
	}
