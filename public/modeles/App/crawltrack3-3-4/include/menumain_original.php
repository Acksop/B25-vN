...
if ($navig == 0 || $navig == 23) // dashboard menu
{
  ...
  <div id="menum4">
		<dl>
			<dt onmouseover="javascript:montre('smenu7');">
				<a
					href="index.php?navig=0&amp;period=<?php echo $period ?>&amp;site=<?php echo $site ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['display_period2'] ?></a>
			</dt>
			<dd id="smenu7">
				<ul>

					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=0&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['today'] ?></a></li>
					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=4&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['8days'] ?></a></li>
					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=1&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['days'] ?></a></li>
					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=2&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['month'] ?></a></li>
					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=3&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['one_year'] ?></a></li>
					<li><a
						href="index.php?navig=<?php echo $navig ?>&amp;period=5&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><?php echo $language['since_beginning'] ?></a></li>
  ...
  <div id="menum7">
		<dl>
			<dt onmouseover="javascript:montre();">
				<a
					href="index.php?navig=0&amp;period=<?php echo $period ?>&amp;site=<?php echo $site ?>&amp;crawler=<?php echo $crawlencode ?>&amp;graphpos=<?php echo $graphpos ?>"><img
					src="./images/house.png" width="16" height="16" border="0"
