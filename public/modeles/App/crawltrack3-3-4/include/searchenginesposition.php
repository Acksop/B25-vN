...
if ($crawltloop < $crawltnbrresult) {
    ...
    if (empty($crawlturlsite)) {
        ...
        $crawltrequeteupdateseo = faireUneRequeteOnLine_Crawltrack($crawltsqlupdateseo, $crawltconnexion);
    } else {
        ...
        if ($crawltloop2 == 0) {
            ...
            $crawltrequetecheck = faireUneRequeteOnLine_Crawltrack($crawltsqlcheck, $crawltconnexion);
            ...
            if ($crawltnbrresultcheck >= 1) {
                ...
                if ($crawltexitingvalue == 0) {
					...
					WHERE `date`= '" . crawlt_sql_quote($crawltdatetoday2) . "'
					AND id_site='" . crawlt_sql_quote($crawltidsite) . "'";
                    $crawltrequeteseo = faireUneRequeteOnLine_Crawltrack($crawltsqlseo, $crawltconnexion);
                }
            } else {
