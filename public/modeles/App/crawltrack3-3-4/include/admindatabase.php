...
if (! isset($_SESSION['optimize'])) {
    ...
    $requeteoptimize1 = faireUneRequeteOnLine_Crawltrack($sqloptimize1, $connexion);
    ...
    $requeteoptimize3 = faireUneRequeteOnLine_Crawltrack($sqloptimize3, $connexion);
    $sqloptimize4 = "OPTIMIZE TABLE crawlt_referer";
    $requeteoptimize4 = faireUneRequeteOnLine_Crawltrack($sqloptimize4, $connexion);
    $_SESSION['optimize'] = 1;
}
$requete = faireUneRequeteOnLine_Crawltrack("show table status", $connexion);
...
while ($result = exploiterLigneResultatBDD_Crawltrack($requete)) {
