...
class DB_sybase extends DB_common
{
     ...
     *
     * @param
     *            a valid sybase result resource
     *            
     * @access public
     *        
     ...
     *        
     * @see DB_common::raiseError(), DB_sybase::errorNative(), DB_sybase::errorCode()
     */
     ...
     *
     * @param array $array
     *            reference of flags array to add a value to
     * @param mixed $value
     *            value to add to the flag array
     *            
     * @return void
     *
     * @access private
