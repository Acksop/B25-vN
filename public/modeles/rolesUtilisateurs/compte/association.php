...
echo "</td><td class='utilisateurs'>" . "<form name='modifInfoAssociation' method='post' action='controlleurs/traitementModifInfoAsso.php'>" . "<input type='hidden' name='voir_Page' value='" . $association['voir_Page'] . "'/>" . "<button type='submit' class='btn_modif'><img src='./images/picto-modifierCircle_up.gif' onMouseOut='this.src=btn_modif_up;' onMouseDown='this.src=btn_modif_down;' onMouseOver='this.src=btn_modif_hover;' alt='Changer?' /></button>" . "</form>";
...
echo "<form enctype='multipart/form-data' action='controlleurs/traitementAssociationAjoutLOGO.php' method='POST'>" . "<input type='hidden' name='MAX_FILE_SIZE' value='2097152'/>" . "<input type='file' size='20' name='Image' class='tweet' />(max 2Mo)" . "<br/>" . "<span style='float:right;'>";
if ($descriptif['logo'] != '') {
...
echo "</span>" . "<input type='hidden' name='id_utilisateur' value='" . $_SESSION['id_utilisateur'] . "'/>" . "<input type='hidden' name='type' value='" . $_SESSION['type_compte'] . "'/>" . "</form>" . "</div>" . "<div id='BanDL' style='background: gray; display:none;'><img src='images/upload.gif' height='120px' width='500px' alt='banni�re de t�l�chargements'/></div>";
if ($descriptif['logo'] != '') {
    echo "<div id='assocLOGO' class='conteneurGrandInterieur'><img src='" . RADIEURAE_SVN_PATH . $descriptif['logo'] . "' alt='{$association['nom']}'/></div>";
}
echo "</div>";
...
echo "<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->" . "<textarea id='elm1' name='elm1' style='width: 100%; height: 400px;'>" . $descriptif_asso . "</textarea>" . "<br/>" . "<span style='float:right;'>";
if ($drapeauAjout) {
...
echo "<script  language='javascript'>" . "
	...
	";
echo "<div id='ajoutStatus' class='conteneurGrand'>" . "<h2 align='left' class='legende'>Bureau</h2>" . "<table border='0' width='900px'>";
if (exploiterNombreLigneResultatBDD($req_status) != 0) {
...
echo "<script language='javascript'>" . "
	...
	";
echo "<div class='conteneurGrand'>" . "<h2 align='left' class='legende'>Membres</h2>" . "<div id='btn_ajoutMembre' class='btn' onMouseDown='AfficheFormAjoutMembre()' style='float:right;'>" . "<img src='images/picto-ajouterMembre_up.gif' onMouseOver='javascript:this.src=btn_ajoutMembre_hover;' onMouseOut='javascript:this.src=btn_ajoutMembre_up;' onMouseDown='javascript:this.src=btn_ajoutMembre_down;' alt='Ajouter un Membre'>" . "</div><br />";
if ($nbMembres != 0) {
    ...
    $i = 0;
    while ($membres = exploiterLigneResultatBDD($req_membres)) {
        echo "<tr><td class=" . $class[$i % 2] . ">" . $membres['membre'] . "</td><td class=" . $class[$i % 2] . ">" . $membres['courriel'] . "</td><td>" . "<a href='./controlleurs/traitementAssociationSuppressionMembre.php?id={$membres['id_membre']}'><img alt='Supprimer' style='float:right;' src='images/picto-supprimer_up.gif' onMouseOver='javascript:this.src=btn_suppr_hover;' onMouseOut='javascript:this.src=btn_suppr_up;' onMouseDown='javascript:this.src=btn_suppr_down;'></a>" . "&nbsp;" . "<img alt='Modifier' style='float:right;' class='btn' src='images/picto-modifier_up.gif' onMouseOver='javascript:this.src=btn_modif_hover;' onMouseOut='javascript:this.src=btn_modif_up;' onMouseDown='javascript:this.src=btn_modif_down;' onClick='AfficheFormModification({$membres['id_membre']},\"{$membres['membre']}\",\"{$membres['courriel']}\")' />" . "</td></tr>";
        $i ++;
    }
    echo "</table></div>";
    echo "<div id='formModifMembre' style='display:none;' class='conteneurInterieur'>" . "<h3 class='legende'>Modification d'un membre : </h3>" . "<form action='./controlleurs/traitementAssociationModificationMembre.php' method='POST' class='membres'>" . "<span id='modifMembre'>" . "<label for='membre'>Identit&eacute; :</label><input type='text' name='membre' placeholder='Nom Pr&eacute;nom' />" . "<label for='courriel'>Courriel :</label><input type='text' name='courriel' placeholder='courriel' />" . "<input type='hidden' name='id'>" . "</span>" . "<br/><br/><span style='float:right;'>" . "<input type='submit' name='save' class='tweet' value='[Modifier]' />" . "&nbsp;" . "<input type='button' value='[Annuler]' class='tweetReset' onClick='AfficheTableauMembre()' />" . "</span>" . "</form></div>";
}
echo "<div id='formAjoutMembre' style='display:none;' class='conteneurInterieur'>" . "<h3 class='legende'>Ajout de membre(s) : </h3>" . "<form action='./controlleurs/traitementAssociationAjoutMembre.php' method='POST' class='membres'>" . "<span style='text-align:left;' id='formMembre'>" . "<label for='membre_1'>Identit&eacute; :</label><input type='text' name='membre_1' placeholder='Nom Pr&eacute;nom' />" . "<label for='courriel_1'>Courriel :</label><input type='text' name='courriel_1' placeholder='courriel' />" . "</span>" . "<img style='float:right;'src='images/picto-ajouterMembre_up.gif' onMouseOver='javascript:this.src=btn_ajoutMembre_hover;' onMouseOut='javascript:this.src=btn_ajoutMembre_up;' onMouseDown='javascript:this.src=btn_ajoutMembre_down;' onClick='AjoutInputMembre()' alt='Ajouter une Saisie'>" . "<br/><br/><span style='float:right;'>" . "<input type='submit' name='save' class='tweet' value='[Valider]' />" . "&nbsp;" . "<input type='button' value='[Annuler]' class='tweetReset' onClick='AfficheBtnAjoutMembre()' />" . "</span>" . "</form>" . "</div>";
echo "<br /></div>";
// -- LES MEMBRES - Fin
// -- LES LIENS - D�but
...
if ($nbLiens != 0) {
    ...
    $i = 0;
    while ($lien = exploiterLigneResultatBDD($req_liens)) {
        echo "<tr><td class=" . $class[$i % 2] . ">" . $lien['libelle_lienWeb'] . "</td><td>" . "<a href='./controlleurs/traitementAssociationSuppressionLien.php?id={$lien['id_lien']}'><img alt='Supprimer' style='float:right;' src='images/picto-supprimer_up.gif' onMouseOver='javascript:this.src=btn_suppr_hover;' onMouseOut='javascript:this.src=btn_suppr_up;' onMouseDown='javascript:this.src=btn_suppr_down;'></a>" . "&nbsp;" . "<img alt='Modifier' class='btn' style='float:right;' src='images/picto-modifier_up.gif' onMouseOver='javascript:this.src=btn_modif_hover;' onMouseOut='javascript:this.src=btn_modif_up;' onMouseDown='javascript:this.src=btn_modif_down;' onClick='AfficheFormModificationLien({$lien['id_lien']},\"{$lien['libelle_lienWeb']}\")'>" . "</td></tr>";
        $i ++;
    }
    echo "</table></div>";
    echo "<br /><div id='formModifLien' style='display:none;' class='conteneurGrand'>" . "<h3 class='legende'>Modification d'un lien Web : </h3>" . "<form action='./controlleurs/traitementAssociationModificationLien.php' method='POST' class='membres'>" . "<span id='modifLien'>" . "<label for='adresse'>Adresse Internet Connexe :</label><input type='text' size='100' name='adresse' placeholder='http:// .... ' />" . "<input type='hidden' name='id'>" . "</span><br/><br/><span style='float:right;'>" . "<input type='submit' name='save' class='tweet' value='[Modifier]' />" . "&nbsp;" . "<input type='button' value='[Annuler]' class='tweetReset' onClick='AfficheTableauLien()' />" . "</span>" . "</form></div>";
}
echo "<br /><div id='formAjoutLien' style='display:none;' class='conteneurGrand'>" . "<h3 class='legende'>Ajout de Lien(s) Web : </h3>" . "<form action='./controlleurs/traitementAssociationAjoutLien.php' method='POST' class='membres'>" . "<span id='formLien'>" . "<label for='adresse_1'>Adresse Internet Connexe :</label><input type='text' size='100' name='adresse_1' placeholder='http:// .... ' />" . "</span>" . "<span style='float:right;'><img src='images/picto-ajouterLien_up.gif' onMouseOver='javascript:this.src=btn_ajoutLien_hover;' onMouseOut='javascript:this.src=btn_ajoutLien_up;' onMouseDown='javascript:this.src=btn_ajoutLien_down;' onClick='AjoutInputLien()' alt='Ajouter une Saisie'></span>" . "<br/><br/>" . "<span style='float:right;'>" . "<input type='submit' name='save' class='tweet' value='[Valider]' />" . "&nbsp;" . "<input type='button' value='[Annuler]' class='tweetReset' onClick='AfficheBtnAjoutLien()' />" . "</span>" . "</form>" . "</div>";
echo "</div>";
//-- LES LIENS - Fin