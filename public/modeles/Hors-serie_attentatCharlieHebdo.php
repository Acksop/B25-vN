...
$header_title = "Besan&ccedil;on 25 - L&apos;e Hors-S&eacute;rie au sujet de l'attentat des daechistes";
$header_description = "Le hors-série#1 de Besan&ccedil;on 25";
$header_identifier_url = "besancon25.fr/hors-serie1";
$header_keywords = "Besan&ccedil;on, Besancon, 25000, 25, hors-serie, Charlie Hebdo, Attentat du 07 Janvier 2015";


function LancerAffichageDuCorps(){
	
	echo "<img src='images/Hors-serie/CharlieHebdo-Attentat07012015/iamcharlie.png' alt='Attentat dans les locaux de Charlie Hebdo' width='604px' height='840px' style='position: relative; display: block; top: 220px; left: 20px;' >";
...
$sql = "SELECT * FROM dossiers WHERE dossiers.id_dossier='20'";
...
function AfficherArticles(){
	...
	."<tr>";
	$sql = "SELECT * FROM articles WHERE (articles.id_article>='56' AND articles.id_article<='59')";
