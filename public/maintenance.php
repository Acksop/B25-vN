...
<title>Besan&ccedil;on 25 - La plate-Forme des artistes/Artisans et des
	groupes/Associations de Besan&ccedil;on - v3.0c - &#948; version</title>
<!---------------------------------------------------------------------------------------------------------------------------------------->
...
<META NAME="Description"
	CONTENT="Site communautaire pour les artistes/Artisans et les Groupes/Associations de Besan&ccedil;on">
...
<body>
	<img src='besancon25.png'
		style='position: absolute; top: 25%; left: 50%;'
		alt='logo de besancon25' />
	<div style='position: absolute; top: 75%; text-align: left;'>
		<h1 style='text-decoration: underline;'>En travaux ...</h1>
		<h6>
			Besan&ccedil;on25 ferme sa plate-forme durant une dur&eacute;
			ind&eacutermin&eacute; pour cause de non-chalance et <u>perte</u> de
			motivation ...
		</h6>
		<h6>
			n'oublier pas que vous pouvez d&eacute;poser des <a
				href='http://besancon25.com'>annonces commerciales</a> ou <a
				href='http://besancon25.net'>&eacute;v&egrave;nementielles</a> les
			domaines associ&eacute;s
		</h6>
	</div>
